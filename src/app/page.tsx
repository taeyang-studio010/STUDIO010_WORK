  ...
  return (
    <AppLayout>
      <div className="flex flex-1 min-h-0">
        <div className="flex w-full max-w-full flex-1 flex-col min-w-0 p-4 sm:p-6 lg:p-8">
            ...
            <div className="w-full min-w-0">
              ...
              <div className="grid w-full min-w-0 grid-cols-1 gap-6 content-stretch md:grid-cols-2">
